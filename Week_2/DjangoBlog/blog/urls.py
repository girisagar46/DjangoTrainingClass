...
from .views import ContactView, PostDetailView, PostListView, search, post_new, contact_us, blog_list, blog_detail
...
urlpatterns = [
    ...
    url(r'^api/', blog_list, name='blog'),
    # url(r'^api/(?P<pk>\d+)/$', blog_detail, name='blog_detail'),
]